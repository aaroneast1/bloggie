  ...
  TermBase.prototype.run = function(connOrOptions, cb) {
    ...
    if ((connOrOptions != null) && connOrOptions.constructor === Object) {
      for (key in connOrOptions) {
        ...
        if (key !== 'connection' && key !== 'useOutdated' && key !== 'noreply' && key !== 'timeFormat') {
...
RDBVal = (function(_super) {
  ...
  RDBVal.prototype.orderBy = function() {
    ...
    if (perhapsOptDict && ((perhapsOptDict instanceof Object) && !(perhapsOptDict instanceof TermBase) && !(perhapsOptDict instanceof Function))) {
      opts = perhapsOptDict;
  ...
  RDBVal.prototype.indexCreate = varar(1, 2, function(name, defun) {
    if (defun != null) {
